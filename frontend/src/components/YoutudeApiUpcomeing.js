...
export const YTvideosUpComing = ({ workout }) => {
  ...
  const upcomingUrl = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=${id}&eventType=upcoming&type=video&key=${key}`;
